      ...
      <ul class="nav navbar-left">
        <?php if(isAuth()): ?>
          <li class="nav-item tasks
            <?php if ($page == "tasks") { echo " on"; } ?>">
            <a class="nav-link" href="task_list.php">View Tasks</a>
          </li>
          <li class="nav-item task
            <?php if ($page == "task") { echo " on"; } ?>">
        ...
        <ul class="nav">
            <?php if(isAuth()): ?>
              <li class="nav-item task
                <?php if ($page == "account") { echo " on"; } ?>">
                <a class="nav-link" href="/account.php">My Account</a>
              </li>
              <li class="nav-item tasks">
                <a class="nav-link" href="/inc/logoutUser.php">Logout</a>
              </li>
            <?php else:?>
            <li class="nav-item tasks
            <?php if ($page == "login") { echo " on"; } ?>">
              <a class="nav-link" href="/login.php">Login</a>
            </li>
            <li class="nav-item tasks
            <?php if ($page == "register") { echo " on"; } ?>">
